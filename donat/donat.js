...
url:function(id){ donat(id); table.id=id; // table.data=window[id].model.table.data;

  table.data=db[id].model.table.data;  d.controller.view();  log(table.id)},
//   log(table.tipe)
//   table.tipe=db[id].model.tipe;
//   table.data=db[id].model.table.data;
//
// log(table.tipe)
//    db[id].controller.view();  log(table.id)},
...
{id:3,nama:"Uplaod",icon:"upload",url:"d.controller.upload()"},
{id:4,nama:"Doenload",icon:"download",url:"d.controller.download()"},
]},
}, //end view
...
input:{data:[],tipe:table.tipe},
button:{data:[
{id:1,nama:"Update",icon:"pen",url:"d.controller.update()"},
{id:1,nama:"Delete",icon:"trush",url:"d.controller.delete()"},
{id:2,nama:"Cancel",icon:"x",url:"d.controller.view()"},
]},
}, //end edit
...
<input id="search" class="input" type="text" onkeyup="d.controller.search()"></div>
...
table={page:page,data:data,rpp:rpp}
...
log(JSON.stringify(d.model.edit))

d.gebi('content').innerHTML=d.view.edit(d.model['edit']);
// d.callback(['edit',table.id]);
log(table.tipe)
